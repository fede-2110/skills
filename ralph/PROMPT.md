...
After selecting a task, emit a status line in this exact format:

```
[RALPH] Task: #<issue_number> - <issue_title>
```

If there are no tasks, emit `<promise>NO MORE TASKS</promise>` as usual.
...
Before exploring, emit:

```
[RALPH] Exploring repo...
```
